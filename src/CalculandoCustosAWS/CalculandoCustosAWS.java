...
public class CalculandoCustosAWS {
    ...
    private static double calcularCustoTotal(double quantidadeServidores, double quantidadeBancosDados, double custoPorHoraServidor, double custoPorHoraBancoDados) {

        double custos = 0;
        return custos = (quantidadeServidores * custoPorHoraServidor) + (quantidadeBancosDados * custoPorHoraBancoDados);
    }
}